const FeatureCard = ({feature, idx}: {feature: {title: string, description: string}, idx: number}) => {
  return (
    <div key={feature.title} className='w-[clamp(30rem,40vw,50rem)] h-[clamp(20rem,30vh,40rem)] flex flex-col items-center justify-center bg-neutral-surface border-1 border-primary-purple p-5 rounded-lg hover:shadow-lg hover:shadow-neutral-white hover:scale-105 duration-300 '>
