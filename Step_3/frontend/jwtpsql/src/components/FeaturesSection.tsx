...
const FeaturesSection = () => {
    ...
    const horizSections = (Features.slice(2).length-1) * 55; //55vw per section

    useGSAP(() => {

        gsap.set(wrapperRef.current, {height: `calc(150vh + ${horizSections}vw)`}); //i cut it in half 280 -> 140 + horizSections*100 -> *50
  ...
  return (
    ...
    <section ref={wrapperRef} className="  w-full flex flex-col items-center justify-center pt-[2.5%] ">
      ...
      <div className='relative w-full h-[200vh] flex flex-col items-center justify-center gap-y-10 lg:gap-y-14 xl:gap-y-16 pt-10'>
