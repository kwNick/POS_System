...
const AddShopButton = () => {
  return (
    <Link href="/shops/add" className="group w-fit h-full flex items-center justify-center gap-2 rounded-lg px-2 underline decoration-primary-blue hover:decoration-primary-blue/80 duration-300">
